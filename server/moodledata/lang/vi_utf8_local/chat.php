<?PHP // $Id$ 
      // chat.php - created with Moodle 1.9.2+ (Build: 20080813) (2007101521)
      // local modifications from http://localhost/moodle192


$string['autoscroll'] = 'Cuốn tự động';
$string['beep'] = 'bíp';
$string['chat:chat'] = 'Tham gia họp';
$string['chat:deletelog'] = 'Xoá nhật chí họp';
$string['chat:readlog'] = 'Xem nhật chí họp';
$string['chatintro'] = 'Nội dung giới thiệu';
$string['chatname'] = 'Tên phòng họp';
$string['chatreport'] = 'Phiên họp';
$string['chattime'] = 'Phiên họp tiếp theo';
$string['configmethod'] = 'Với kiểu họp bình thường, trình duyệt sẽ nối kết thường xuyên tới máy chủ để cập nhật thông tin. Không cần phải thiết lập gì cả, và ở đâu cũng hoạt động được. Tuy nhiên, máy chủ sẽ có thể bị nặng tải, đặc biệt la khi có nhiều người cùng tham gia họp. Sử dụng máy chủ daemon đòi hỏi bạn phải truy cập vào môi trường dòng lệnh Unix, nhưng bù lại các phiên họp sẽ có thể diễn ra suôn sẻ và nhanh chóng hơn.';
$string['confignormalupdatemode'] = 'Bạn có thể dùng chức năng <em>Nối thường trực</em> của HTTP 1.1 để cập nhật các phòng họp một cách hiệu quả, nhưng việc đó sẽ làm nặng tải trên máy chủ của bạn. Phương pháp cập nhật <em>Dòng</em> có thể cho kết quả tốt hơn khi có nhiều người truy cập cùng lúc (tương tự cách dùng chatd), nhưng có thể là không được hỗ trợ trên máy chủ của bạn.';
...
$string['currentchats'] = 'Phiên họp đang mở';
