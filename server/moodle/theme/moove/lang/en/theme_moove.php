...
$string['prev_section'] = 'Trước đó';
$string['next_section'] = 'Kế tiếp';
$string['search_site'] = 'Tìm kiếm trong trang';
$string['search_forums'] = 'Tìm kiếm khóa học';
$string['platform_access'] = 'Đăng nhập hệ thống';
$string['readmore'] = 'Đọc thêm';
$string['stayintouch'] = 'Thông tin liên hệ';
$string['madewitmoodle'] = 'Một sản phẩm của';
$string['madeby'] = 'Điều chỉnh';
$string['by'] = 'bởi';
...
$string['notcalculatedyet'] = 'Chưa tính toán';
$string['calculatediskusagetask'] = 'Tổng dung lượng sử dụng';
$string['totalusers'] = 'Hoạt động / Tạm hoãn';
$string['totalcourses'] = 'Tổng số khóa học';
$string['onlineusers'] = 'Thành viên đang trực tuyến (5 phút trước)';
$string['showhideblocks'] = 'Hiện/ẩn khối';
$string['prev_activity'] = 'Hoạt động trước';
$string['next_activity'] = 'Hoạt động tiếp';
...
// Mypublic page.
$string['userprofile'] = 'Thông tin cá nhân';
$string['competencyplans'] = 'Danh sách năng lực';
$string['details'] = 'Chi tiết';
$string['startedon'] = 'Bắt đầu tại';
$string['addcontact'] = 'Thêm liên hệ';
$string['removecontact'] = 'Xóa liên hệ';
$string['certificates'] = 'Chứng nhận';
