...
$string['advancedoptions'] = 'Lựa chọn nâng cao';
$string['allday'] = 'Mọi ngày';
...
$string['categoryevents'] = 'Danh mục sự kiện';
$string['coursecalendar'] = '{$a} calendar';
$string['courses'] = 'Courses';
$string['customexport'] = 'Điều chỉnh khoảng ({$a->timestart} - {$a->timeend})';
$string['daily'] = 'Daily';
$string['day'] = 'Day';
$string['dayeventsmany'] = '{$a->num} sự kiện, {$a->day}';
$string['dayeventsnone'] = 'Không sự kiện, {$a}';
$string['dayeventsone'] = '1 sự kiện, {$a}';
$string['daynext'] = 'Ngày kế';
...
$string['deleteevents'] = 'Xóa nhiều sự kiện';
$string['deleteoneevent'] = 'Xóa sự kiện này';
$string['deleteallevents'] = 'Xóa toàn bộ sự kiện';
...
$string['erroraddingevent'] = 'Lỗi! Không thể thêm sự kiện';
