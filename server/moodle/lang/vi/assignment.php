<?PHP // $Id$ 
      // assignment.php - created with Moodle 1.9.2+ (Build: 20080813) (2007101521)
...
$string['assignment:submit'] = 'Gửi nộp bài';
...
Bạn có thể xem ở phần kèm theo bài tập của mình:
    ...
    $a->url';
$string['assignmentmailhtml'] = '$a->teacher vừa viết vài nhận xét cho bài tập \'<i>$a->assignment</i>\' mà bạn đã nộp<br /><br />
...
$string['commentinline'] = 'Ghi chú trong bài';
$string['configitemstocount'] = 'Những kiểu tài liệu có thể được chấp nhận như bài tập nộp trực tuyến của sinh viên';
$string['configmaxbytes'] = 'Dung lượng tối đa mặc định của bài tập nộp vào hệ thống (và còn phụ thuộc thêm vào thiết lập của khóa học hay các thiết lập cục bộ khác)';
$string['configshowrecentsubmissions'] = 'Tất cả đều có thể xem các thông báo nộp bài trong các báo cáo những hoạt động gần nhất.';
...
$string['emailteachers'] = 'Gửi điện thư thông báo cho học viên';
...
$string['nofiles'] = 'Không có bài nào được nộp lên';
...
$string['overwritewarning'] = 'Chú ý: tải bài lên lại sẽ THAY THẾ bài đã nộp hiện tại.';
$string['pagesize'] = 'Số bài nộp hiển thị trong mỗi trang';
$string['preventlate'] = 'Cấm nộp bài trễ';
...
$string['typeonline'] = 'Văn bản trực tuyến';
